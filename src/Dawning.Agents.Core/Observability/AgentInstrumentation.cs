...
public static class AgentInstrumentation
{
    ...
    /// 设置活跃请求数回调
    /// </summary>
    public static void SetActiveRequestsCallback(Func<int> callback) => _activeRequestsCallback = callback;

    /// <summary>
    /// 设置健康实例数回调
    /// </summary>
    public static void SetHealthyInstancesCallback(Func<int> callback) => _healthyInstancesCallback = callback;
