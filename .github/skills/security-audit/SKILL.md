...
description: |
  ...
  Don't use when:
    ...
    - Full codebase audit across all dimensions (use deep-audit)
    - Writing fixes for found issues (use code-update)
    - Checking dependency versions only (use dependency-update)
